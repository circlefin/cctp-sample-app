...
A sample app used to demonstrate CCTP step by step capabilities on testnet. The app currently supports Ethereum Goerli, Avalanche Fuji C-Chain, OP Goerli, and Arbitrum Goerli testnets.
